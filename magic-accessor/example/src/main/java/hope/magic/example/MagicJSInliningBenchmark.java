...
public class MagicJSInliningBenchmark {
	...
	public static void main(String[] args) throws Throwable {
		...
		// 1. 密集算术与循环脚本
		System.out.println(">>> [1] 编译并预热算术密集型脚本 (Prime Sum 1000)...");
		...
		// 2. Java 实例方法直调
		System.out.println(">>> [2] 编译并预热 Java 实例方法直调 (target.multiply(6, 7))...");
		...
		// 3. 箭头函数与 SAM 接口适配
		System.out.println(">>> [3] 编译并预热 SAM 接口转换 (target.computeBinary((x, y) => x * y + 5, 4, 5))...");
		...
		System.out.println(">>> [4] 编译并预热 for..of Java List 遍历...");
		...
		// 5. 正则表达式测试与匹配
		System.out.println(">>> [5] 编译并预热 RegExp 匹配与执行...");
		...
		System.out.println(">>> [6] 编译并预热多态数据流与高频类型变化流水线 (5 形状多态 + 裸浮点槽直读)...");
		...
		System.out.println(">>> [7] 复杂对象读写");
		JSScript complexObjScript = JSCompiler.compile("""
