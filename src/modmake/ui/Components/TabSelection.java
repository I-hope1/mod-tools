...
public class TabSelection {
    public static Table build(Seq<String> list, Prov<String> holder,
                              Cons2<String, Integer> cons,
    ...
    public static Table build(Seq<String> list, Prov<String> holder,
                              Cons2<String, Integer> cons, TextButton.TextButtonStyle style,
                              int width, int height, int cols){
        return buildWithChecked(list, holder, cons, style, width, height, true, cols);

    }
    public static Table buildWithChecked(Seq<String> list, Prov<String> holder,
                              Cons2<String, Integer> cons, TextButton.TextButtonStyle style,
                              int width, int height, boolean checked, int cols) {
		Table p = new Table();
        p.clearChildren();
