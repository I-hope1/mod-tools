...
public class MagicInstaller {
	private static boolean installedMagic = false;
	public static void installMagic() {
		if (!installedMagic && !OS.isAndroid) {
			initMagicClass(bytes -> HopeReflect.defineClass(null, null, bytes));
			installedMagic = true;
		}
	}
	private static void initMagicClass(Consumer<byte[]> definer) {
		try {
