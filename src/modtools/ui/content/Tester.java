...
public class Tester extends Content {
	...
	boolean error;
	final float w = Core.graphics.isPortrait() ? 440f : 540f;
	...
	public static class JSFunc {
		...
		public void showInfo(Object o) {
			...
			cont.table(t -> {
				...
				t.button(Icon.copy, Styles.cleari, () -> Core.app.setClipboardText(finalC.getTypeName()));
