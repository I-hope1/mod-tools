...
public class PatternUtils {
	...
	/**
	 * 尝试编译给定的字符串为正则表达式，如果发生异常则返回 {@code null}。
	 ...
	 * 编译给定的字符串为正则表达式。
	 * @param text 要编译的正则表达式字符串
	 * @return 编译后的 Pattern 对象，如果 text 为 {@code null} 或空字符串则返回 {@link #ANY}
	 */
	...
	/**
	 * 测试给定的文本是否匹配给定的正则表达式。
	 * @param pattern 正则表达式的 {@link Pattern} 对象
	 * @param text    要测试的文本
	 * @return {@code pattern} 不为空 且 文本匹配正则表达式 则返回 {@code true}
	 */
	 ...
	 * 如果 pattern 为 {@code null} 返回 {@code false}.<br>
