...
import static modtools.graphics.MyShaders.shaderFi;
...
public class Blur {
	...
	public Blur() {
		blurShader = new Shader(Core.files.internal("shaders/screenspace.vert"), shaderFi.child("gaussian_blur.frag"));
	...
	public void render() {
		...
		capturing = false;
		buffer.end();
		if (!settings.getBool("毛玻璃", false)) return;
